# SM-HR 多环境差异矩阵（Multi-Env Matrix）
...
| 数据库 | dev 实例（sm_hr） | staging 实例 | 生产主从（sm_hr） |
| Ingress 域名 | sm-hr.dev.sm.example.com | sm-hr.staging.sm.example.com | sm-hr.sm.example.com |
